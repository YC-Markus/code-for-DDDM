...
from .reco_train import para_prepare_parallel, para_prepare
...
class TrainLoop:
    ...
    def forward_backward(self, batch, cond, t, ssim_loss=None, lpip_loss=None, helper=None):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            if last_batch or not self.use_ddp:
                losses, model_output = compute_losses()
            else:
        ...
        model_output_copy = model_output.data
        return model_output_copy
    ...
    def save(self):
        def save_checkpoint(rate, params):
            ...
            if dist.get_rank() == 0:
                ...
                with bf.BlobFile(bf.join('/root/autodl-tmp/TASK8/improved_diffusion/model_save_FULL/', filename), "wb") as f:
